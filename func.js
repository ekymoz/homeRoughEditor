...
document.getElementById("report_mode").addEventListener("click", function () {
    ...
    $("#reportTools").show(200, function () {
        ...
        for (let k in ROOM) {
            ...
            reportRoom +=
                '<div class="col-md-6"><p>' + nameRoom + "</p></div>\n";
            reportRoom +=
        ...
        for (let k in OBJDATA) {
            if (OBJDATA[k].class === "energy") {
                ...
                if (
                    ...
                    plugNumber++;
                if (
                    OBJDATA[k].type === "wallLight" ||
                    OBJDATA[k].type === "roofLight"
                )
                    lampNumber++;
            }
        }
        ...
        for (let k in ROOM) {
            ...
            if (ROOM[k].name != "") nameRoom = ROOM[k].name;
            reportRoom +=
                '<div class="col-md-4"><p>' + nameRoom + "</p></div>\n";
            switchNumber = 0;
            plugNumber = 0;
            let plug20 = 0;
            let plug32 = 0;
            ...
            reportRoom +=
                '<div class="col-md-2"><b>' + switchNumber + "</b></div>\n";
            reportRoom +=
                '<div class="col-md-2"><b>' + plugNumber + "</b></div>\n";
            reportRoom +=
                '<div class="col-md-2"><b>' + lampNumber + "</b></div>\n";
            reportRoom +=
                '<div class="col-md-2"><b>' + wattMax + "</b></div>\n";
            number++;
            reportRoom += "</div>";
        }
...
window.addEventListener("load", function () {
    ...
    document
        ...
        .addEventListener("transitionend", function () {
            document.getElementById("moveBox").style.transform =
                "translateX(-165px)";
            document.getElementById("zoomBox").style.transform =
                "translateX(-165px)";
        });
...
function rib(shift = 5) {
    ...
    for (let i in WALLS) {
        if (WALLS[i].equations.base) {
                ...
                if (i != p && WALLS[p].equations.base) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            distance =
                                qSVG.measure(WALLS[i].coords[0], inter) / meter;
                            pushToRibMaster(
                                ribMaster,
                                0,
                                i,
                        ...
                        if (
                            ...
                            distance =
                                qSVG.measure(WALLS[i].coords[1], inter) / meter;
                            pushToRibMaster(
                                ribMaster,
                                1,
                                i,
            ...
            distance =
                qSVG.measure(WALLS[i].coords[0], WALLS[i].coords[3]) / meter;
            pushToRibMaster(
                ribMaster,
                0,
                i,
            ...
            distance =
                qSVG.measure(WALLS[i].coords[1], WALLS[i].coords[2]) / meter;
            pushToRibMaster(
                ribMaster,
                1,
                i,
    ...
    for (let t in ribMaster) {
        for (let a in ribMaster[t]) {
            for (let n = 1; n < ribMaster[t][a].length; n++) {
                if (
                    ribMaster[t][a][n - 1].wallIndex ===
                    ribMaster[t][a][n].wallIndex
                ) {
                    let edge = ribMaster[t][a][n].wallIndex;
                    let found = true;
                    let valueText = Math.abs(
                        ribMaster[t][a][n - 1].distance -
                            ribMaster[t][a][n].distance
                    );
                    ...
                    if (
                        found &&
                        ribMaster[t][a][n - 1].crossEdge ===
                            ribMaster[t][a][n].crossEdge &&
                        ribMaster[t][a][n].crossEdge !=
                            ribMaster[t][a][n].wallIndex
                    ) {
                        found = false;
                    ...
                    if (found && ribMaster[t][a].length > 2 && n === 1) {
                        ...
                        for (let pp = 0; pp < 4; pp++) {
                            polygon.push({
                                x: WALLS[ribMaster[t][a][n].crossEdge].coords[
                                    pp
                                ].x,
                                y: WALLS[ribMaster[t][a][n].crossEdge].coords[
                                    pp
                                ].y,
                            }); // FOR Z
                        }
                        if (
                            qSVG.rayCasting(ribMaster[t][a][0].coords, polygon)
                        ) {
                            found = false;
                        }
                    }
                    ...
                    if (
                        ...
                        for (let pp = 0; pp < 4; pp++) {
                            polygon.push({
                                x: WALLS[ribMaster[t][a][n - 1].crossEdge]
                                    .coords[pp].x,
                                y: WALLS[ribMaster[t][a][n - 1].crossEdge]
                                    .coords[pp].y,
                            }); // FOR Z
                        }
                        if (
                            qSVG.rayCasting(
                                ribMaster[t][a][ribMaster[t][a].length - 1]
                                    .coords,
                                polygon
                            )
                        ) {
                    ...
                    if (found) {
                        let angleText =
                            WALLS[ribMaster[t][a][n].wallIndex].angle *
                            (180 / Math.PI);
                        ...
                        if (sizeText[n].textContent < 1) {
                            ...
                            sizeText[n].textContent = sizeText[
                                n
...
$("#grid_mode").click(function () {
    if (grid_snap === "on") {
        ...
        $("#grid_mode").html(
            'GRID ON <i class="fa fa-th" aria-hidden="true"></i>'
        );
